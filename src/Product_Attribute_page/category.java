  ...
  //        options.addArguments("--disable-extensions");
				 ...
				 for(int k=3; k<=sheet.getLastRowNum();k++)
		         {
					 if(k==4)
					 	...
					 	try
					 	{
					 		...
					 		Usermenu=driver.findElement(By.xpath(".//*[@id='jqgh_category-table_MaterialCategory1']")).getText();
					 		...
					 		if("Material Category".equals(Usermenu))
					 		{
					...
					// 	Assert.assertEquals("Material Category", Usermenu);
		         }
	}
				 ...
				 for(int k=3; k<=sheet.getLastRowNum();k++)
		         {
					 if(k==4)
					 	...
					 	try
					 	{
				 			...
				 			je.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath(".//*[@id='add_category-table' and @title='Add new row']/div/span")));
					 		...
					 		{
					 			sheet.getRow(148).createCell(9).setCellValue("PASS");
					 		}
					 		else
					 		{
					 			sheet.getRow(148).createCell(9).setCellValue("FAIL");
					 		}
	...
	public void AddRecord_Alertmessage() throws InterruptedException
	{
			  ...
			  int counts=0;
				 for(int k=3; k<=sheet.getLastRowNum();k++)
		         {
					 if(k==4)
					 	...
					 	try
					 	{
					 		...
					 		if(AddRecord_alertmessage.trim().contentEquals("Material Category: field is required"))
					 		{
					 			sheet.getRow(154).createCell(9).setCellValue("PASS");
					 		...
					 		{
					 			sheet.getRow(154).createCell(9).setCellValue("FAIL");
				...
				//	 	Assert.assertEquals("Material Category: field is required", AddRecord_alertmessage.trim());
		         }
	}
	@Test(priority=6)
				 ...
				 for(int k=3; k<=sheet.getLastRowNum();k++)
		         {
					 if(k==4)
					 	...
					 	try
					 	{
					 		...
					 		{
					 			sheet.getRow(160).createCell(9).setCellValue("PASS");
					 		}
					 		else
					 		{
					 			sheet.getRow(160).createCell(9).setCellValue("FAIL");
					 		}
				 ...
				 for(int k=3; k<=sheet.getLastRowNum();k++)
		         {
					 if(k==4)
					 	...
					 	try
					 	{
					 		...
					 		if("Material Attribute".equals(User1))
					 		{
					 			sheet.getRow(166).createCell(9).setCellValue("PASS");
					 		}
					 		else
					 		{
					 			sheet.getRow(166).createCell(9).setCellValue("FAIL");
					 		}
				 ...
				 for(int k=0; k<=sheet.getLastRowNum();k++)
		         {
				 	...
				 	try
					 	...
					 	//	Company_Addrecord_button();
			 				...
			 				driver.findElement(By.xpath(".//*[@id='MaterialCategory1']")).sendKeys(Systemname);
				 ...
				 for(int k=14; k<=sheet.getLastRowNum();k++)
		         {
				 	...
				 	try
			 			...
			 			List<WebElement> record1=driver.findElements(By.xpath(".//span[@class='ui-icon ui-icon-trash']"));
			 				...
			 				if(count==1)
			 				{
			 					sheet.getRow(172).createCell(9).setCellValue("PASS");
			 				}
			 				else
			 				{
			 					sheet.getRow(172).createCell(9).setCellValue("FAIL");
			 				}
	...
	public void Enter_record_Alertmessage() throws InterruptedException
	{
			  ...
			  int counts=0;
				 for(int k=0; k<=sheet.getLastRowNum();k++)
		         {
				 	...
				 	try
					 	...
					 	//	Company_Addrecord_button();
			 				...
			 				if("Material category already exists!".equals(AlreadyExit))
			 				{
			 					sheet.getRow(178).createCell(9).setCellValue("PASS");
			 				}
			 				else
			 				{
			 					sheet.getRow(178).createCell(9).setCellValue("FAIL");
			 				}
				...
				// 	Assert.assertEquals("Material category already exists!", AlreadyExit);
		         }
	}
