  ...
  //        options.addArguments("--disable-extensions");
	...
	public void User_Submenu() throws InterruptedException
	{
			  ...
			  int counts=0;
				 for(int k=3; k<=sheet.getLastRowNum();k++)
		         {
					 if(k==4)
					 	...
					 	try
					 	{
					 		...
					 		Usermenu=driver.findElement(By.xpath(".//*[@id='a-material']")).getText();
					 		
					 		System.out.println("User menu "+Usermenu);
					 		
					 		Thread.sleep(4000);
					 		if("Material".equals(Usermenu))
					 		{
				...
				//	 	Assert.assertEquals("Material", Usermenu);
		         }
	}
	...
	public void Customer_page() throws InterruptedException
	{
			  ...
			  int counts=0;
				...
				//	 	Assert.assertEquals("Material", User);
		         }
	}
	...
	public void AddRecord_Alertmessage() throws InterruptedException
	{
			  ...
			  int counts=0;
				 for(int k=3; k<=sheet.getLastRowNum();k++)
		         {
					 if(k==4)
					 	...
					 	try
					 	{
					 		...
					 		if(AddRecord_alertmessage.trim().contentEquals("Material: field is required"))
					 		{
					 			sheet.getRow(25).createCell(9).setCellValue("PASS");
					 		...
					 		{
					 			sheet.getRow(25).createCell(9).setCellValue("FAIL");
				...
				//	 	Assert.assertEquals("Material: field is required", AddRecord_alertmessage.trim());
		         }
	}
