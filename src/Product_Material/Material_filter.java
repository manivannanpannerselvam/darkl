...
public class Material_filter {
  ...
  //        options.addArguments("--disable-extensions");
				 ...
				 if(k==4)
				 	...
				 	try
				 	{
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click(
					 		...
					 		driver.findElement(By.xpath(".//*[@id='gs_Material1']")).sendKeys(SystemName);
					 		
					 		Thread.sleep(3000);
					 		
					 		driver.findElement(By.xpath(".//*[@id='gs_Material1']")).sendKeys(Keys.ENTER);
					 		
					 		Thread.sleep(4000);
					 		
					 		 Filtersystemname=driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_Material1'])[last()]")).getText();
	...
	@Test(priority=3)
	public void Filter_clearmaterial() throws InterruptedException
	{
				 ...
				 if(k==4)
				 	...
				 	try
				 	{
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click(
					 		...
					 		driver.findElement(By.xpath(".//*[@id='gs_Material1']")).clear();
					 		...
					 		Thread.sleep(4000);
					 		 ...
					 		 Filtersystemname=driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_Material1'])[last()-9]")).getText();
					 		...
					 		if(SystemName.equals(Filtersystemname))
					 		{
					 			...
					 			sheet.getRow(110).createCell(9).setCellValue("FAIL");
					 		}
					 		else
					 		{
					 			sheet.getRow(110).createCell(9).setCellValue("PASS");
					 		}
			 ...
			 for(int k=3; k<=sheet.getLastRowNum();k++)
	         {
				 if(k==4)
				 	...
				 	try
				 	{
				 		...
				 		ShortName=(String)row.getCell(15).getStringCellValue();
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click();
					 		...
					 		driver.findElement(By.xpath(".//*[@id='gs_MaterialDescription']")).sendKeys("desc");
					 		
					 		Thread.sleep(3000);
					 		
					 		driver.findElement(By.xpath(".//*[@id='gs_MaterialDescription']")).sendKeys(Keys.ENTER);
					 		
					 		Thread.sleep(4000);
					 		
					 		WebElement element11 =

				 					driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialDescription'])[last()]"));
					 		 ...
					 		 FilterShortname=driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialDescription'])[last()]")).getText();
					 		
					 		System.out.println("Filter compnay " +FilterShortname);
					 		
					 		
					 		
					 		if("desc".equals(FilterShortname))
					 		{
				...
				// 	Assert.assertEquals("desc", FilterShortname);
	         }
	}
	...
	public void Filter_LastName() throws InterruptedException
	{
		  ...
		  int counts=0;
			 for(int k=3; k<=sheet.getLastRowNum();k++)
	         {
				 if(k==4)
				 	...
				 	try
				 	{
				 		...
				 		LastName=(String)row.getCell(15).getStringCellValue();
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click();
			 				...
			 				driver.findElement(By.xpath(".//span[@aria-labelledby='select2-gs_MaterialBrandID-container' and @class='select2-selection select2-selection--single']")).click();
			 				
			 				
			 				driver.findElement(By.xpath(".//input[@class='select2-search__field' and @type='search']")).sendKeys("testbrand69");
					 		...
					 		WebElement element11 =
				 					...
				 					driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialBrandID'])[last()]"));
					 		 ...
					 		 FilterLastName=driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialBrandID'])[last()]")).getText();
					 		
					 		System.out.println("Filter compnay " +FilterLastName);
					 		
					 		
					 		
					 		if("testbrand69".equals(FilterLastName))
					 		{
			...
			//	 	Assert.assertEquals("testbrand69", FilterLastName);
	         }
	}
	
	@Test(priority=6)
	public void Filter_subbrand() throws InterruptedException
	{
				 ...
				 if(k==4)
				 	...
				 	try
				 	{
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click();
			 				...
			 				driver.findElement(By.xpath(".//span[@aria-labelledby='select2-gs_MaterialSubBrandID-container' and @class='select2-selection select2-selection--single']")).click();
					 		...
					 		WebElement element11 =
				 					...
				 					driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialSubBrandID'])[last()]"));
					 		 ...
					 		 FilterLastName=driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialSubBrandID'])[last()]")).getText();
	...
	@Test(priority=7)
	public void Filter_category() throws InterruptedException
	{
				 ...
				 if(k==4)
				 	...
				 	try
				 	{
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click();
			 				...
			 				driver.findElement(By.xpath(".//span[@aria-labelledby='select2-gs_MaterialCategoryID-container' and @class='select2-selection select2-selection--single']")).click();
					 		...
					 		Thread.sleep(4000);
					 			...
					 			WebElement element11 =
				 					...
				 					driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialSubCategoryID'])[last()]"));
					 		 ...
					 		 FilterLastName=driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialSubCategoryID'])[last()]")).getText();
	...
	@Test(priority=8)
	public void Filter_Subcategory() throws InterruptedException
	{
				 ...
				 if(k==4)
				 	...
				 	try
				 	{
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click();
			 				...
			 				driver.findElement(By.xpath(".//span[@aria-labelledby='select2-gs_MaterialSubCategoryID-container' and @class='select2-selection select2-selection--single']")).click();
	...
	@Test(priority=9)
	public void Filter_Segment() throws InterruptedException
	{
				 ...
				 if(k==4)
				 	...
				 	try
				 	{
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click();
			 				...
			 				driver.findElement(By.xpath(".//span[@aria-labelledby='select2-gs_MaterialSegmentID-container' and @class='select2-selection select2-selection--single']")).click();
					 		...
					 		Thread.sleep(4000);
				 					...
				 					driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialSegmentID'])[last()]"));

				 					((JavascriptExecutor)

				 					driver).executeScript("arguments[0].scrollIntoView();", element11);
					 		
					 		 FilterLastName=driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialSegmentID'])[last()]")).getText();
	...
	@Test(priority=10)
	public void Filter_subSegment() throws InterruptedException
	{
				 	...
				 	try
				 	{
		 				...
		 				System.out.println("Username is " + LastName);
				 			...
				 			WebElement element =
				 					...
				 					driver.findElement(By.xpath(".//span[@aria-labelledby='select2-gs_MaterialSubSegmentID-container' and @class='select2-selection select2-selection--single']"));
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click();
			 				...
			 				driver.findElement(By.xpath(".//span[@aria-labelledby='select2-gs_MaterialSubSegmentID-container' and @class='select2-selection select2-selection--single']")).click();
					 		...
					 		Thread.sleep(8000);
				 					...
				 					driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialSubSegmentID'])[last()]"));
					 		 ...
					 		 FilterLastName=driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialSubSegmentID'])[last()]")).getText();
	...
	@Test(priority=11)
	public void Filter_family() throws InterruptedException
	{
				 	...
				 	try
				 	{
		 				...
		 				System.out.println("Username is " + LastName);
				 			...
				 			WebElement element =
				 					...
				 					driver.findElement(By.xpath(".//span[@aria-labelledby='select2-gs_MaterialFamilyID-container' and @class='select2-selection select2-selection--single']"));
				 		...
				 		//	driver.findElement(By.xpath(".//*[@id='customer']/span")).click();
			 				...
			 				driver.findElement(By.xpath(".//span[@aria-labelledby='select2-gs_MaterialFamilyID-container' and @class='select2-selection select2-selection--single']")).click();
					 		...
					 		Thread.sleep(8000);
				 					...
				 					driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialFamilyID'])[last()]"));
					 		 ...
					 		 FilterLastName=driver.findElement(By.xpath("(.//*[@aria-describedby='material-table_MaterialFamilyID'])[last()]")).getText();
					 		...
					 		if("testbrand69".equals(FilterLastName))
					 		{
					 			...
					 			sheet.getRow(142).createCell(9).setCellValue("PASS");
					 		}
					 		else
					 		{
					 			sheet.getRow(142).createCell(9).setCellValue("FAIL");
					 		}
